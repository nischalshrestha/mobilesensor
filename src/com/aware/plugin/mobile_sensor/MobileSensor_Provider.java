package com.aware.plugin.mobile_sensor;
...
public class MobileSensor_Provider extends ContentProvider {
	...
	*/
	public static String AUTHORITY = "com.aware.plugin.mobile_sensor.provider.mobile_sensor";
	/**
	...
	*/
	public static final String DATABASE_NAME = Environment.getExternalStorageDirectory() + "/AWARE/plugin_mobile_sensor.db";
	/**
	* Database tables:
	* – plugin_phone_usage
	*/
	public static final String[] DATABASE_TABLES = {"plugin_mobile_sensor"};
	/**
...
//		tableMap.put(MobileSensor_Data.AMBIENT_NOISE, MobileSensor_Data.AMBIENT_NOISE);
	...
	public static final class MobileSensor_Data implements BaseColumns {
		...
		*/
		public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/plugin_mobile_sensor");
		/**
		...
		*/
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.aware.plugin.mobile_sensor";
		/**
		* How each row is identified individually internally in Android (vnd.android.cursor.item). 
		* It needs to be /vnd.aware.plugin.XXX where XXX is your plugin name (no spaces!).
		*/
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.aware.plugin.mobile_sensor";
