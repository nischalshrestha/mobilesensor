...
public class Plugin extends Aware_Plugin {
	...
	*/
	public static final String ACTION_AWARE_PLUGIN_MOBILE_SENSOR = "ACTION_AWARE_PLUGIN_MOBILE_SENSOR";
	/**
	* Broadcasted event: the user has turned on his phone
	*/
	public static final String STATUS_PLUGIN_MOBILE_SENSOR = "status_plugin_mobile_sensor";
	/**
